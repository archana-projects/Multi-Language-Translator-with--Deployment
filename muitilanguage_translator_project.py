...
df = pd.read_csv(r"C:\Users\kumar\FULLSTACK DATASCIENCE\AI(Artificial Intelligence)\MULTI LANGUAGE TRANSLATOR\language.csv")
#C:\Users\kumar\FULLSTACK DATASCIENCE\AI(Artificial Intelligence)\MULTI LANGUAGE TRANSLATOR\language.csv
